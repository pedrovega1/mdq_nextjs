...
const faqItems = [
  ...
  },
  {
    ...
    answer: (
      <div>
        Гранты для медиатренеров предоставляются в целях проведения обучающих
        тренингов и курсов по следующим темам:
        <ul>
          <li> аналитическая журналистика; </li>
          <li>освещение чувствительных тем (профессиональная медиаэтика);</li>
          <li>
            критический анализ и объективность при изучении и подаче информации.
          </li>
        </ul>
      </div>
    ),
...
Малые медиа из областей Казахстана имеют уникальную возможность выиграть грант от трех до десяти миллионов тенге для реализации своих социально значимых проектов, одновременно привлекая новую целевую аудиторию!  
Прошедшие конкурсный отбор малые СМИ могут продвинуть свои программы, статьи, сюжеты или подкасты на новый уровень. Пора повысить свои знания и стать одним из лучших СМИ в Казахстане! Сделаем профессию журналиста еще лучше!
          </CardDescription>
        </CardHeader>
        <div className="p-4">
          <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
              <a href="https://forms.gle/cq2R7Zo1z6xyP79w7">Подать заявку</a>
            </span>
          </button>
