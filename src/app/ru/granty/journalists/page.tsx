...
const faqItems = [
  {
    ...
    answer:
      "Акселератором является КФ «Медиа дамыту қоры», разработавший специальную программу для развития и роста малых СМИ. Гранты на акселерацию малых СМИ предоставляются для разработки социально значимых медиапроектов с вовлечением новой целевой аудитории.",
  },
  {
    question: "Малые СМИ – что это? ",
    answer:
      "Это небольшие средства массовой информации, которые публикуют и показывают значимый для населения информационный контент. Являются актуальными только в своем регионе. Не способные конкурировать с республиканскими СМИ.",
  },
  {
...

  {
    ...
    answer:
      "- малые СМИ, находящие на стадии реорганизации, ликвидации или банкротства, а также деятельность, которых приостановлена в соответствии с действующим законодательством РК; - малые СМИ, имеющие задолженность по налогам и другим обязательным платежам в бюджет; - малые СМИ, в отношении которых возбуждено исполнительное производство.",
  },
  {
    question: "По каким категориям выдаются гранты?    ",
    answer:
      "- социально значимый медиапроект; - отраслевой медиапроект; - медиапроект для выхода на новую целевую аудиторию.",
  },
  {
    question: "Что подразумевается под медиапроектом?    ",
    answer:
      " - Социально значимый медиапроект должен поднять актуальную социальную проблему в регионе и предложить ее решение.  - Отраслевой медиапроект должен поднять актуальные вопросы отдельной отрасли, имеющие отношение к повседневной жизни общества, предложить пути их решений.  - Задача медиапроекта для выхода на новую целевую аудиторию — вовлечение новой целевой аудитории, обоснованное социальной актуальностью.",
  },
  {
    question:
      "Какие условия должны быть соблюдены для регистрации малых СМИ в рамках грантовой программы?    ",
    answer:
      "Малые СМИ должны иметь государственную регистрацию в соответствии с законодательством Республики Казахстан. А также иметь штатную численность не более 10 человек. Количество посещений своего сайта за последние 3 месяца не более 1 млн человек, либо охват аудитории в Instagram, или TikTok, или Telegram, или YouTube не более 100 000 аккаунтов.    ",
  },
  {
  ...
  {
    question:
      "По итогам реализации гранта обязаны ли малые СМИ предоставить отчет о проделанной работе?",
    answer:
      "По итогам реализации гранта малые СМИ обязаны представить готовую медиапродукцию для демонстрации полученных знаний и компетенций, подтверждения целевого освоения гранта.",
  },
  {
    question: "Как узнать результаты рассмотрения заявки?",
    answer:
      "Результаты рассмотрения заявки будут сообщены специалистами отдела поддержки масс медиа КФ «Медиа дамыту қоры». С вами свяжутся.",
  },
  {
    ...
    <main className="">
      <Card className="place-self-center lg:ml-96 max-w-6xl m-5 my-8 ">
        ...
        <video controls className="responsive-video p-4">
          <source src="/video-grants/mediaru.webm" type="video/webm" />
        </video>
